...
},{"./react-super-select":3,"lodash":6}],2:[function(require,module,exports){
'use strict';
...
},{"./AutoCompleteField":1,"immutable":5,"lodash":6}],3:[function(require,module,exports){
'use strict';
...
var ReactSuperSelect = React.createClass({
  ...
  _broadcastChange: function _broadcastChange() {
    var outputValue = this._isMultiSelect() ? this.state.value : _.head(this.state.value);
...
},{"classnames":4,"lodash":6}],4:[function(require,module,exports){
/*!
